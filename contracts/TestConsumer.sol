...
contract ATestnetConsumer is ChainlinkClient, Ownable {
  ...
  // I add this function for the ease of deployment, so I do not
  // need to change the source code every time I deploy a new linktoken
  // contract, only for local testing
  function mySetChainlinkToken(address _link) public onlyOwner {
